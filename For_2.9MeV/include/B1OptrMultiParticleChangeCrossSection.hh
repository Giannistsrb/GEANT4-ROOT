...
#ifndef B1OptrMultiParticleChangeCrossSection_hh
#define B1OptrMultiParticleChangeCrossSection_hh 1

#include "G4VBiasingOperator.hh"
class B1OptrChangeCrossSection;
class G4ParticleDefinition;

#include <map>

class B1OptrMultiParticleChangeCrossSection : public G4VBiasingOperator {
public:
  B1OptrMultiParticleChangeCrossSection();
  virtual ~B1OptrMultiParticleChangeCrossSection() {}
...
private:
  ...
  std::map < const G4ParticleDefinition*, 
            B1OptrChangeCrossSection* >    fBOptrForParticle;
  std::vector < const G4ParticleDefinition* >   fParticlesToBias;
 B1OptrChangeCrossSection*                  fCurrentOperator;
