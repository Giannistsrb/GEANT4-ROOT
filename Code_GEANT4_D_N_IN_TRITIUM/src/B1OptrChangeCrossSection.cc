...
B1OptrChangeCrossSection::B1OptrChangeCrossSection(G4String particleName,
                                                         G4String         name)
...
B1OptrChangeCrossSection::~B1OptrChangeCrossSection()
{
...
void B1OptrChangeCrossSection::StartRun()
{
  // --------------
  // -- Setup stage:
  // ---------------
...
G4VBiasingOperation* 
B1OptrChangeCrossSection::ProposeOccurenceBiasingOperation(const G4Track*            track, 
                                                                               ...
                                                                               callingProcess)
{
  ...
  // NA VALAW NA MOU DINEI SECONDARIES
  //   if (processname == "protonInelastic")
  // { 
   // G4cout<< "NAME "<< processname <<G4endl; 
   // G4cout<< "analog length = "<< G4BestUnit(10000/analogInteractionLength,"Length") <<G4endl;
 // }
 
 if ( analogInteractionLength > DBL_MAX/10. ) return 0;
//G4cout<< "analog length = "<< G4BestUnit(analogInteractionLength,"Length") <<G4endl;
  ...
  G4double XStransformation                          = detectorConstruction->GetBiasingFactor();
