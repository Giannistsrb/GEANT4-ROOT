...

{
  ...
  //All deuterons peaks:
  analysisManager->CreateH1("Deuteron_Peaks", "Deuterons", 2001, 0.* MeV, 3. * MeV, "MeV");
  ...
  //==================================================================================
  //Neutrons energy for Au11 (histNum: 8-12):
  analysisManager->CreateH1("Au11_Target_1stFoil_NeutronsAll",      "Au11 Target(1st foil). All neutrons",               2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Au11_Target_1stFoil_TargetMoly",       "Au11 Target(1st foil). Neutrons from Molybdenum",   2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Au11_Target_1stFoil_TargetTiT",        "Au11 Target(1st foil). Neutrons from TiT",          2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Au11_Target_1stFoil_TargetCopper",     "Au11 Target(1st foil). Neutrons from Copper",       2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Au11_Target_1stFoil_TargetNotMoAndCu", "Au11 Target(1st foil). Neutrons not from Mo or Cu", 2001, 0.* MeV, 20. * MeV, "MeV");  //Neutrons from everywhere except for Mo and Cu

  //==================================================================================
  //Neutrons energy for Tl1 (histNum: 13-17):
  analysisManager->CreateH1("Tl1_1stFoil_NeutronsAll",      "Tl1 Target(1st foil). All neutrons",               2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Tl1_1stFoil_TargetMoly",       "Tl1 Target(1st foil). Neutrons from Molybdenum",   2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Tl1_1stFoil_TargetTiT",        "Tl1 Target(1st foil). Neutrons from TiT",          2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Tl1_1stFoil_TargetCopper",     "Tl1 Target(1st foil). Neutrons from Copper",       2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Tl1_1stFoil_TargetNotMoAndCu", "Tl1 Target(1st foil). Neutrons not from Mo or Cu", 2001, 0.* MeV, 20. * MeV, "MeV"); //Neutrons from everywhere except for Mo and Cu


  //==================================================================================
  //Neutrons energy for Al6 (histNum: 18-22):
  analysisManager->CreateH1("Al6_2ndFoil_NeutronsAll",      "Al6(2nd foil). All neutrons",               2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Al6_2ndFoil_TargetMoly",       "Al6(2nd foil). Neutrons from Molybdenum",   2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Al6_2ndFoil_TargetTiT",        "Al6(2nd foil). Neutrons from TiT",          2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Al6_2ndFoil_TargetCopper",     "Al6(2nd foil). Neutrons from Copper",       2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("Al6_2ndFoil_TargetNotMoAndCu", "Al6(2nd foil). Neutrons not from Mo or Cu", 2001, 0.* MeV, 20. * MeV, "MeV"); //Neutrons from everywhere except for Mo and Cu

  
  //==================================================================================
  //Neutrons energy for Ge76(histNum: 23-27):
  ...
  //==================================================================================
  //Neutrons energy for Al7 (histNum: 28-32):
  ...
  //==================================================================================
  //Neutrons energy for AuX (histNum: 33-37):
  analysisManager->CreateH1("AuX_5thFoil_NeutronsAll",      "AuX(5th foil). All neutrons",               2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("AuX_5thFoil_TargetMoly",       "AuX(5th foil). Neutrons from Molybdenum",   2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("AuX_5thFoil_TargetTiT",        "AuX(5th foil). Neutrons from TiT",          2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("AuX_5thFoil_TargetCopper",     "AuX(5th foil). Neutrons from Copper",       2001, 0.* MeV, 20. * MeV, "MeV");
  analysisManager->CreateH1("AuX_5thFoil_TargetNotMoAndCu", "AuX(5th foil). Neutrons not from Mo or Cu", 2001, 0.* MeV, 20. * MeV, "MeV"); //Neutrons from everywhere except for Mo and Cu
...
void B1RunAction::BeginOfRunAction(const G4Run *run)
{
  ...
  analysisManager->SetFileName("2.11MeV_10^9_biasTarget=HeTiT_f=100_fnInteractions>1_YesWeight.root");
...
//-------------------------------------------------------------
//For Au11-target (1st Foil):

void B1RunAction::Au11NeutronEnergy(G4double neutronKinEn)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(8, neutronKinEn);
}

void B1RunAction::Au11NeutronEnergyfromMoly(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(9, neutronKin);
}

void B1RunAction::Au11NeutronEnergyfromTiT(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(10, neutronKin);
}

void B1RunAction::Au11NeutronEnergyfromCopper(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(11, neutronKin);
}

void B1RunAction::Au11NeutronEnergyNotFromMoAndCu(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(12, neutronKin);
}

//For Tl1-target (1st Foil):

void B1RunAction::Tl1NeutronEnergy(G4double neutronKinEn)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(13, neutronKinEn);
}

void B1RunAction::Tl1NeutronEnergyfromMoly(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(14, neutronKin);
}

void B1RunAction::Tl1NeutronEnergyfromTiT(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(15, neutronKin);
}

void B1RunAction::Tl1NeutronEnergyfromCopper(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
...
void B1RunAction::Tl1NeutronEnergyNotFromMoAndCu(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
...
//-------------------------------------------------------------
//For Al6 (2nd Foil):
void B1RunAction::Al6NeutronEnergy(G4double neutronKinEn)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(18, neutronKinEn);
}

void B1RunAction::Al6NeutronEnergyfromMoly(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(19, neutronKin);
}

void B1RunAction::Al6NeutronEnergyfromTiT(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(20, neutronKin);
}

void B1RunAction::Al6NeutronEnergyfromCopper(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
  analysisManager->FillH1(21, neutronKin);
}

void B1RunAction::Al6NeutronEnergyNotFromMoAndCu(G4double neutronKin)
{
  auto analysisManager = G4AnalysisManager::Instance();
