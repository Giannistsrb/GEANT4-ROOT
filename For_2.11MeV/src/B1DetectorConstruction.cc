...
{ 
  ...
  G4SolidStore::GetInstance()->Clean();
   ...
   //Determine the Tritium Element (isotope):
    ...
    TiT->AddMaterial(titanium,  0.3932400); 
  ...
  //We need: aluminum, hydrogen, oxygen, carbon, iron, gold, germanium, thallium:
  ...
  G4Material *thallium  = nist->FindOrBuildMaterial("G4_Tl");

  //DETERMINE SPECIAL MATERIALS:
  //WE NEED: mylar_mat, Ge76_mat.
  /////////////////////////////////////////////////////////////////
  //Densities:
  ...
  G4double d_flange_holder_bottom = 3.4 * cm;
  ...
  G4double d_flange_holder_right = 3.4 * cm;
...
//-----------------------------------------------------------------------------------------------------------
  ...
  G4double d_flange_holder_left = 3.4 * cm;
...
//-----------------------------------------------------------------------------------------------------------
  //FIRST FOIL: Name: 'Au11_Tl1' 
  //Consists of the 'target_Au11', 'target_Tl1', 'ring_Au11_Tl1', 'mylar_Au11_Tl1'. 
  ...
  G4double d_flange_target_Au11     = 3.573 * cm;
  G4double d_flange_target_Tl1      = 3.600 * cm;
  G4double d_flange_ring_Au11_Tl1   = 3.600 * cm;
  G4double d_flange_mylar_Au11_Tl1  = 3.600 * cm;
  //Depths for every 'subfoil':
  G4double l_target_Au11     = 0.027 * cm;
  G4double l_target_Tl1      = 0.203 * cm;
  G4double l_ring_Au11_Tl1   = 0.140 * cm;
  G4double l_mylar_Au11_Tl1  = 0.140 * cm;
  //Radiuses:
  G4double r_target_Au11         = 0.670 * cm;
  G4double r_target_Tl1          = 0.650 * cm;
  G4double r_ring_min_Au11_Tl1   = 2.431 * cm;
  G4double r_ring_max_Au11_Tl1   = 2.983 * cm;
  G4double r_mylar_min_Au11_Tl1  = 0.670 * cm;
  G4double r_mylar_max_Au11_Tl1  = 2.431 * cm;
  //z-axis position of the left corners of the 'subfoils':
  G4double z_flange_target_Au11     = endOfFlange + d_flange_target_Au11;
  G4double z_flange_target_Tl1      = endOfFlange + d_flange_target_Tl1;
  G4double z_flange_ring_Au11_Tl1   = endOfFlange + d_flange_ring_Au11_Tl1;
  G4double z_flange_mylar_Au11_Tl1  = endOfFlange + d_flange_mylar_Au11_Tl1;
  //z-axis positions in the centers of the 'subfoils':
  G4double center_target_Au11     = z_flange_target_Au11    + l_target_Au11    * 0.5;
  G4double center_target_Tl1      = z_flange_target_Tl1     + l_target_Tl1     * 0.5;
  G4double center_ring_Au11_Tl1   = z_flange_ring_Au11_Tl1  + l_ring_Au11_Tl1  * 0.5;
  G4double center_mylar_Au11_Tl1  = z_flange_mylar_Au11_Tl1 + l_mylar_Au11_Tl1 * 0.5;
  //-----------------------------------------------------------------------------------------------------------
  //Starting the construction of the geometry:
  //Au11-target. Material = G4_Au.
  G4Tubs *target_Au11 = new G4Tubs("target-Au11", 
                                               0,
                                   r_target_Au11,  
                               l_target_Au11 / 2,
                                      0.   * deg,
  ...
  G4LogicalVolume *logic_target_Au11 = new G4LogicalVolume(target_Au11, 
                                                                  gold, 
                                                  "logical_target_Au11");

  new G4PVPlacement(                                       0,
                    G4ThreeVector(0., 0., center_target_Au11), 
                                            logic_target_Au11,
                                           "Au11_target_phys",
                                                  logicWorld,
                                                       false,
  ...
  //Tl1-target. Material = G4_Tl.
  G4Tubs *target_Tl1 = new G4Tubs("target-Tl1", 
                                               0,
                                    r_target_Tl1,  
                                l_target_Tl1 / 2,
                                      0.   * deg,
  ...
  G4LogicalVolume *logic_target_Tl1 = new G4LogicalVolume(target_Tl1, 
                                                            thallium, 
                                                  "logical_target_Tl1");

  new G4PVPlacement(                                       0,
                    G4ThreeVector(0., 0., center_target_Tl1), 
                                            logic_target_Tl1,
                                           "Tl1_target_phys",
                                                  logicWorld,
                                                       false,
  ...
  //Au11-Tl1-ring. Material = G4_Fe.
  G4Tubs *ring_Au11_Tl1 = new G4Tubs("ring-Au11-Tl1", 
                                 r_ring_min_Au11_Tl1,
                                 r_ring_max_Au11_Tl1,  
                                 l_ring_Au11_Tl1 / 2,
                                          0.   * deg,
  ...
  G4LogicalVolume *logic_ring_Au11_Tl1 = new G4LogicalVolume(ring_Au11_Tl1, 
                                                                      iron, 
                                                   "logical_ring_Au11_Tl1");

  new G4PVPlacement(                                      0,
                    G4ThreeVector(0., 0., center_ring_Au11_Tl1), 
                                            logic_ring_Au11_Tl1,
                                           "Au11_Tl1_ring_phys",
                                                     logicWorld,
                                                          false,
  ...
  //Au11-Tl1-mylar.
  G4Tubs *mylar_Au11_Tl1 = new G4Tubs( "mylar-Au11-Tl1", 
                                   r_mylar_min_Au11_Tl1,
                                   r_mylar_max_Au11_Tl1,  
                                   l_mylar_Au11_Tl1 / 2,
                                             0.   * deg,
                                             360. * deg);

  G4LogicalVolume *logic_mylar_Au11_Tl1 = new G4LogicalVolume(mylar_Au11_Tl1, 
                                                                   mylar_mat, 
                                                    "logical_mylar_Au11_Tl1");

  new G4PVPlacement(                                      0,
                    G4ThreeVector(0., 0., center_mylar_Au11_Tl1), 
                                            logic_mylar_Au11_Tl1,
                                           "Au11_Tl1_mylar_phys",
                                                      logicWorld,
                                                           false,
                                                               0,
                                                            true);
  //-----------------------------------------------------------------------------------------------------------
  //SECOND FOIL: Name: 'Al6' 
  //Consists of the 'target_Al6', 'ring_Al6', 'mylar_Al6'. 
  //We need to set (a) the distance between the end of flange and the left corner of every 'subfoil', 
  //(b) the center of every 'subfoil', (c) the depth of each and (d) the radius of each. 
  //-----------------------------------------------------------------------------------------------------------
  //Variables: 
  //Distances between the end of flange and the left corner of every 'subfoil':
  G4double d_flange_target_Al6 = 4.00 * cm;
  G4double d_flange_ring_Al6   = 4.00 * cm;
  G4double d_flange_mylar_Al6  = 4.00 * cm;
  //Depths for every 'subfoil':
  G4double l_target_Al6 = 0.050  * cm;
  G4double l_ring_Al6   = 0.140  * cm;
  G4double l_mylar_Al6  = 0.140  * cm;
  //Radiuses:
  G4double r_target_Al6      = 1.000 * cm;
  G4double r_ring_min_Al6    = 2.431 * cm;
  G4double r_ring_max_Al6    = 2.983 * cm;
  G4double r_mylar_min_Al6   = 1.000 * cm;
  G4double r_mylar_max_Al6   = 2.431 * cm;
  //z-axis position of the left corners of the 'subfoils':
  G4double z_flange_target_Al6 = endOfFlange + d_flange_target_Al6;
  G4double z_flange_ring_Al6   = endOfFlange + d_flange_ring_Al6;
  G4double z_flange_mylar_Al6  = endOfFlange + d_flange_mylar_Al6;
  //z-axis positions in the centers of the 'subfoils':
  G4double center_target_Al6 = z_flange_target_Al6 + l_target_Al6 * 0.5;
  G4double center_ring_Al6   = z_flange_ring_Al6   + l_ring_Al6   * 0.5;
  G4double center_mylar_Al6  = z_flange_mylar_Al6  + l_mylar_Al6  * 0.5;
  //-----------------------------------------------------------------------------------------------------------
  //Starting the construction of the geometry:
  //Al6-target. Material = aluminum.
  G4Tubs *target_Al6 = new G4Tubs("target-Al6", 
                                             0,
                                  r_target_Al6,  
                              l_target_Al6 / 2,
                                    0.   * deg,
  ...
  G4LogicalVolume *logic_target_Al6 = new G4LogicalVolume(target_Al6, 
                                                            aluminum, 
                                                 "logical_target_Al6");

  new G4PVPlacement(                                       0,
                    G4ThreeVector(0., 0., center_target_Al6), 
                                            logic_target_Al6,
                                           "Al6_target_phys",
                                                  logicWorld,
                                                       false,
  ...
  //Al6-ring. Material = iron.
  G4Tubs *ring_Al6 = new G4Tubs("ring-Al6", 
                            r_ring_min_Al6,
                            r_ring_max_Al6,  
                            l_ring_Al6 / 2,
                                0.   * deg,
  ...
  G4LogicalVolume *logic_ring_Al6 = new G4LogicalVolume(ring_Al6, 
                                                            iron, 
                                               "logical_ring_Al6");

  new G4PVPlacement(                                     0,
                    G4ThreeVector(0., 0., center_ring_Al6), 
                                            logic_ring_Al6,
                                           "Al6_ring_phys",
                                                logicWorld,
                                                     false,
  ...
  //Al6-mylar. Material = mylar_mat.
  G4Tubs *mylar_Al6 = new G4Tubs( "mylar-Al6", 
                              r_mylar_min_Al6,
                              r_mylar_max_Al6,  
                              l_mylar_Al6 / 2,
                                   0.   * deg,
  ...
  G4LogicalVolume *logic_mylar_Al6 = new G4LogicalVolume(mylar_Al6, 
                                                         mylar_mat, 
                                                "logical_mylar_Al6");

  new G4PVPlacement(                                      0,
                    G4ThreeVector(0., 0., center_mylar_Al6), 
                                            logic_mylar_Al6,
                                           "Al6_mylar_phys",
                                                 logicWorld,
                                                      false,
  ...
  //Variables: 
  //Distances between the end of flange and the left corner of every 'subfoil':
  G4double d_flange_target_Ge76 = 4.20 * cm;
  G4double d_flange_ring_Ge76   = 4.20 * cm;
  G4double d_flange_mylar_Ge76  = 4.20 * cm;
  //Depths for every 'subfoil':
  ...
  //Variables: 
  //Distances between the end of flange and the left corner of every 'subfoil':
  G4double d_flange_target_Al7 = 4.69 * cm;
  G4double d_flange_ring_Al7   = 4.60 * cm;
  G4double d_flange_mylar_Al7  = 4.60 * cm;
  //Depths for every 'subfoil':
  G4double l_target_Al7 = 0.05   * cm;
  G4double l_ring_Al7   = 0.14   * cm;
  G4double l_mylar_Al7  = 0.09   * cm;
  //Radiuses:
  ...
  //-----------------------------------------------------------------------------------------------------------
  //FIFTH FOIL: Name: 'AuX' 
  //Consists of the 'target_AuX', 'ring_AuX', 'mylar_AuX'. 
  //We need to set (a) the distance between the end of flange and the left corner of every 'subfoil', 
  //(b) the center of every 'subfoil', (c) the depth of each and (d) the radius of each. 
  //-----------------------------------------------------------------------------------------------------------
  //Variables: 
  //Distances between the end of flange and the left corner of every 'subfoil':
  G4double d_flange_target_AuX = 4.88 * cm;
  G4double d_flange_ring_AuX   = 4.80 * cm;
  G4double d_flange_mylar_AuX  = 4.80 * cm;
  //Depths for every 'subfoil':
  G4double l_target_AuX = 0.06  * cm;
  G4double l_ring_AuX   = 0.14  * cm;
  G4double l_mylar_AuX  = 0.08  * cm;
  //Radiuses:
  G4double r_target_AuX    = 1.000 * cm;
  G4double r_ring_min_AuX  = 2.431 * cm;
  G4double r_ring_max_AuX  = 2.983 * cm;
  G4double r_mylar_AuX     = 2.431 * cm;
  //z-axis position of the left corners of the 'subfoils':
  G4double z_flange_target_AuX = endOfFlange + d_flange_target_AuX;
  G4double z_flange_ring_AuX   = endOfFlange + d_flange_ring_AuX;
  G4double z_flange_mylar_AuX  = endOfFlange + d_flange_mylar_AuX;
  //z-axis positions in the centers of the 'subfoils':
  G4double center_target_AuX = z_flange_target_AuX + l_target_AuX * 0.5;
  G4double center_ring_AuX   = z_flange_ring_AuX   + l_ring_AuX   * 0.5;
  G4double center_mylar_AuX  = z_flange_mylar_AuX  + l_mylar_AuX  * 0.5;
  //-----------------------------------------------------------------------------------------------------------
  //Starting the construction of the geometry:
  //AuX-target. Material = G4_Au.
  ...
  //AuX-ring. Material = iron.
  G4Tubs *ring_AuX = new G4Tubs("ring-AuX", 
                            r_ring_min_AuX,
                            r_ring_max_AuX,  
                            l_ring_AuX / 2,
                                0.   * deg,
  ...
  G4LogicalVolume *logic_ring_AuX = new G4LogicalVolume(ring_AuX, 
                                                            iron, 
                                               "logical_ring_AuX");

  new G4PVPlacement(                                     0,
                    G4ThreeVector(0., 0., center_ring_AuX), 
                                            logic_ring_AuX,
                                           "AuX_ring_phys",
                                                logicWorld,
                                                     false,
  ...
  //AuX-mylar.
  G4Tubs *mylar_AuX = new G4Tubs( "mylar-AuX", 
                                            0,
                                  r_mylar_AuX,  
                              l_mylar_AuX / 2,
                                   0.   * deg,
  ...
  G4LogicalVolume *logic_mylar_AuX = new G4LogicalVolume(mylar_AuX, 
                                                          mylar_mat, 
                                                 "logical_mylar_AuX");

  new G4PVPlacement(                                      0,
                    G4ThreeVector(0., 0., center_mylar_AuX), 
                                            logic_mylar_AuX,
                                           "AuX_mylar_phys",
                                                 logicWorld,
                                                      false,
...
//----------------------------------------------------------------------------------------------------------------
    ...
    flogicColl     = logicColl;
    flogicAntiBase = logicAntiBase;
    flogicAnti     = logicAnti;
    flogicFlange   = logicFlange;
    fMolybdenum    = logicMoly;
    fTiT           = logicTit;
    fCopper        = logicCop;
    //-----------------------------------------------------
    //Second part (5 extra foils):
    fAu11          = logic_target_Au11;      //Au11 foil     (#1)
    fTl1           = logic_target_Tl1;       //Tl1  foil     (#1)
    fAl6           = logic_target_Al6;       //Al7  foil     (#2)
    fGe76          = logic_target_Ge76;      //Ge76 foil     (#3)
    fAl7           = logic_target_Al7;       //Al8  foil     (#4)
    fAuX           = logic_target_AuX;       //AuX  foil     (#5)
